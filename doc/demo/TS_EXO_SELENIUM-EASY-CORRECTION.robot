...
Test01 Selenium Menu Input Forms - Simple Form Demo - Two Input Fields
    ...
    SeleniumLibrary.Input Text    id = value1    10
    SeleniumLibrary.Input Text    name = sum2    4
    SeleniumLibrary.Click Element    //button[@onclick="return total()"]
...
Test02 Selenium Menu Input Forms - Checkbox Demo - Single Checkbox Demo
    ...
    Run Keyword And Continue On Failure    SeleniumLibrary.Wait Until Element Is Visible    css=#txtAge
    SeleniumLibrary.Wait Until Element Contains    css=#txtAge    Success - Check box is checked
...
Test03 Selenium Menu Input Forms - Checkbox Demo - Multiple Checkbox Demo
    ...
    Highlight Element    //div[text()="Multiple Checkbox Demo"]
    # Corrigé de l'exercice
    SeleniumLibrary.Click Element    //input[@value='Check All']
    SeleniumLibrary.Click Element    //input[@value='Uncheck All']
    SeleniumLibrary.Wait Until Page Contains Element    //label[text()='Option 1']/input
    SeleniumLibrary.Select Checkbox    //label[text()='Option 1']/input
    SeleniumLibrary.Wait Until Page Contains Element    //input[@id='check1' and @value='Check All']
    # EST MEILLEUR
    Wait Until Element Attribute Contains    //input[@id='check1']    value    Check All
    SeleniumLibrary.Wait Until Page Contains Element    //label[text()='Option 2']/input
    SeleniumLibrary.Select Checkbox    //label[text()='Option 2']/input
    SeleniumLibrary.Wait Until Page Contains Element    //label[text()='Option 3']/input
    SeleniumLibrary.Select Checkbox    //label[text()='Option 3']/input
    SeleniumLibrary.Wait Until Page Contains Element    //label[text()='Option 4']/input
    SeleniumLibrary.Select Checkbox    //label[text()='Option 4']/input
    SeleniumLibrary.Wait Until Page Contains Element    //input[@id='check1' and @value='Uncheck All']
    # EST MEILLEUR
    Wait Until Element Attribute Contains    //input[@id='check1']    value    Uncheck All
    ${value}    SeleniumLibrary.Get Element Attribute    //input[@id='check1']    value
...
Test04 Selenium Menu Input Forms - Radio Buttons Demo - Radio Button Demo
    ...
    # Corrigé de l'exercice
    SeleniumLibrary.Wait Until Element Is Enabled    //*[@name='optradio' and @value='Male']
    SeleniumLibrary.Wait Until Element Is Visible    //*[@name='optradio' and @value='Male']
    SeleniumLibrary.Wait Until Page Contains Element    //*[@name='optradio' and @value='Male']
    SeleniumLibrary.Select Radio Button    optradio    Male
    SeleniumLibrary.Click Element    //button[@id='buttoncheck']
    SeleniumLibrary.Wait Until Element Contains    class = radiobutton    Radio button 'Male' is checked
    ${genre}    BuiltIn.Set Variable    Female
    SeleniumLibrary.Wait Until Page Contains Element    //*[@name='optradio' and @value='${genre}']
    # //input[@name="optradio" and @value="Female"]
    SeleniumLibrary.Select Radio Button    optradio    ${genre}
    SeleniumLibrary.Click Element    id = buttoncheck
    SeleniumLibrary.Wait Until Element Contains    class = radiobutton    Radio button '${genre}' is checked
...
Test05 Selenium Menu Input Forms - Select Dropdown List - Select List Demo 6
    ...
    SeleniumLibrary.Select From List By Value    //select[@class='form-control']    Wednesday
    SeleniumLibrary.Wait Until Element Contains    class = selected-value    Wednesday
    # Corrigé de l'exercice difficile
    ${countItem}    SeleniumLibrary.Get Element Count    //select[@id='select-demo']/option
...
Test06 Selenium Menu Input Forms - Select Dropdown List - Multi Select List Demo 7
    ...
    SeleniumLibrary.Click Element    //select[@id="multi-select"]/option[@value='Florida']
    SeleniumLibrary.Click Element    //select[@id="multi-select"]/option[@value='Texas']    CTRL
    ${selectedValues}    SeleniumLibrary.Wait Until Page Contains Element    id = multi-select
    SeleniumLibrary.Click Element    id = printMe
    SeleniumLibrary.Wait Until Element Contains    class = getall-selected    First selected option is : Florida
    SeleniumLibrary.Click Element    id = printAll
    SeleniumLibrary.Wait Until Element Contains    class = getall-selected    Options selected are : Florida,Texas
...
Test08 Selenium Menu Table - Table Data Search - Type in your search
    ...
    # Exemple de solution rapide par XPATH
    ${columnAssignee}    Get Text    //tr[contains(., "jQuery library")]/td[3]
    BuiltIn.Log    Assignee: ${columnAssignee}
    # Exemple par une boucle qui parcoure tout le tableau
    ${elementcount}    SeleniumLibrary.Get Element Count    //table[@id='task-table']/tbody/tr
    FOR    ${index}    IN RANGE    1    ${elementcount}+1
        SeleniumLibrary.Wait Until Page Contains Element    //table[@id='task-table']/tbody/tr[${index}]/td[2]
        ${columnTask}    SeleniumLibrary.Get Text    //table[@id='task-table']/tbody/tr[${index}]/td[2]
        ${columnAssignee}    SeleniumLibrary.Get Text    //table[@id='task-table']/tbody/tr[${index}]/td[3]
        IF    '''${columnTask}''' == 'jQuery library'    BREAK
    END
    BuiltIn.Log    Assignee: ${columnAssignee}
...
Test09 Selenium Menu Progress Bars & Sliders - Drag & Drop Sliders - Range Sliders
    ...
    SeleniumLibrary.Click Element    //div[@id="slider1"]//input
    BuiltIn.Repeat Keyword    40    Collections.Append To List    ${KEYS}    ARROW_RIGHT
    SeleniumLibrary.Press Keys    //div[@id="slider1"]//input    @{KEYS}

    SeleniumLibrary.Element Text Should Be    //div[@id="slider1"]//output    90
    # Pour atteindre 89 en 3 coups
    SeleniumLibrary.Click Element    //div[@id="slider1"]//input
    SeleniumLibrary.Press Keys    //div[@id="slider1"]//input    END    PAGE_DOWN    ARROW_LEFT
...
Test10 Selenium Menu Table - Table Pagination - Table with Pagination Example
    ...
    # Compter le nombre de page
    ${nombrePage}    SeleniumLibrary.Get Element Count    //ul[@id='myPager']//a[contains(@class,'page_link')]
    # Sur quelle page sommes nous ?
    ${activePagePardefaut}    SeleniumLibrary.Get Text    //ul[@id='myPager']//a[@class='page_link active']

    #${nombreLigne}    SeleniumLibrary.Get Element Count    //table//tr[contains(@style,'table-row')]
    ...
    FOR    ${INDEX}    IN RANGE    1    ${nombrePage+1}
        ...
        ...    //ul[@id='myPager']//a[contains(@class,'next_link')]
        IF    ${nextIsPresent}
            SeleniumLibrary.Click Element    //ul[@id='myPager']//a[contains(@class,'next_link')]
        END
    END
    ${indexDerniereLigne}    SeleniumLibrary.Get Text
    ...    //tbody[@id='myTable']//tr[contains(@style,'table-row')][last()]/td[1]
...
Test Unitaire de Wait Until Element Attribute Contains
    ...
    Run Keyword And Continue On Failure    Run Keyword And Expect Error    locator id:xx not found    Wait Until Element Attribute Contains    id:xx    value    Check All    2
    Log    CAS D'ERREUR AVEC MAUVAIS NOM D'ATTRIBUT
    ${expected}    Set Variable    locator id:check1 found but the value of attribute xx is different \nExpected=Check All != Actual=None \n<input type="button" class="btn btn-primary" id="check1" value="Check All">
    Run Keyword And Continue On Failure    Run Keyword And Expect Error    ${expected}    Wait Until Element Attribute Contains    id:check1    xx    Check All    2
    Log    CAS D'ERREUR AVEC MAUVAISE VALEUR D'ATTRIBUT
    ${expected}    Set Variable    locator id:check1 found but the value of attribute value is different \nExpected=xx != Actual=Check All \n<input type="button" class="btn btn-primary" id="check1" value="Check All">
    Run Keyword And Continue On Failure    Run Keyword And Expect Error    ${expected}    Wait Until Element Attribute Contains    id:check1    value    xx    2
